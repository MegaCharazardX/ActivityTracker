...
# root.set_default_color_theme("CTkThemesPack-main\CTkThemesPack-main\themes\lavender.json")  # Themes: "blue" (standard), "green", "dark-blue"
# root.mainloop()
...
class App(CTk):
    def __init__(self):
        ...
        self.sidebar_button_2 = CTkButton(self.sidebar_frame, command=self.sidebar_button_event)
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)
        self.sidebar_button_3 = CTkButton(self.sidebar_frame, command=self.sidebar_button_event)
        ...
        self.main_button_1 = CTkButton(master=self, fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"))
        ...
        self.label_tab_2 = CTkLabel(self.tabview.tab("Tab 2"), text="CTkLabel on Tab 2")
        ...
        self.scrollable_frame = CTkScrollableFrame(self, label_text="CTkScrollableFrame")
        self.scrollable_frame.grid(row=1, column=2, padx=(20, 0), pady=(20, 0), sticky="nsew")
        self.scrollable_frame.grid_columnconfigure(0, weight=1)
        self.scrollable_frame_switches = []
        for i in range(100):
            switch = CTkSwitch(master=self.scrollable_frame, text=f"CTkSwitch {i}")
